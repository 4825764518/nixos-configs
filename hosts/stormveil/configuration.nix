...

{
  ...
  in {
    ...
    b2Backup = {
      ...
      extraBackupArgs = remoteBackupExcludePaths;
  ...
  systemd.services."stormveil-iscsi-mount" = {
    ...
    script = ''
      ...
      ${pkgs.mount}/bin/mount -t xfs -o discard /dev/disk/by-uuid/2e1225e2-9e91-4461-af01-6c229086bda5 /mnt/linux-game-libraries
    '';
  };
